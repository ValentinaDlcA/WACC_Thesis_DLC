...
# ---------------------------------------------------------------
# 5. Apply scaling to macro-scenario data
# ---------------------------------------------------------------
macro_std = macro_df.copy()
macro_std[cont_vars] = scaler.transform(macro_std[cont_vars])

# ---------------------------------------------------------------
# 6. Fixed Effects model coefficients (no constant term)
# ---------------------------------------------------------------
coef = {
    "gdp_ppp": -0.0274,
    "population": 0.0682,
...
# ---------------------------------------------------------------
# 7. Generate projections by technology type
# ---------------------------------------------------------------
tech_map = {
...
# ---------------------------------------------------------------
# 8. Save final projection result
# ---------------------------------------------------------------
out_path = (
